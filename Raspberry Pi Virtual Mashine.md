...
На вопросы Fix \<y\>? отвечаем y. После завершения проверки нажать Ctrl-D.
...
Выполнив эти команды, мы установим кириллические консольные шрифты, Midnight Commander, мышь консольного режима и произведем обновление системы.

Теперь можно попробовать запустить X window командой startx, кроме того можно подключится к нашей виртуальной машине по ssh.
