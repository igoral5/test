...
|`git log --since=2.weeks`                                    |	Выводит историю коммитов, сделанных за последние 2 недели              |
...
То есть ветка client в свое время основанная на ветке server, перебазируется на ветку master, причем изменения сделанные на ветке server не попадают в ветку master, в том числе коммит C3. Если теперь переключится на ветку master:<br>
...
Фактически все изменения сделанные на тематической ветке client, влиты в основную ветку master, а изменения сделанные на ветке server нет.
</td>
</tr>
<tr>
...
В итоге все изменения сделанные на ветках client и server влиты в основную ветку master и их можно удалить:<br>
