...
### Подключение к репозитарию на github.com или bitbucket.org
| Команда                                             | Описание                                                     |
|:----------------------------------------------------|:-------------------------------------------------------------|
| `git init`                                          | Создать в пустом каталоге новый репозитарий                  |
| `vim .gitignore`                                    | Создать файл описывающий файлы игнорирования                 |
| `git add .gitignore`                                | Добавить файл .gitignore в индекс                            |
| `git commit -m "Initial commit"`                    | Сделать первый коммит                                        |
| `git remote add origin git@github.com:igoral5/mysite.git` | Добавить удаленный репозитарий                         |
| `git branch --set-upstream-to=origin/master master` | Указать ветки по умолчанию для pull и push                   |
| `git pull`                                          | Подтянуть изменения из удаленного репозитария. На этом этапе могут быть конфлиты, необходимо разрешить их |
